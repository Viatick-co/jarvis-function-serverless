...
class JarvisServerless {
    constructor(apiPrefix, version, serviceName, dbHost, dbPort, dbName, dbUsn, dbPwd, modelsPath, sqlLog) {
        this.routeMap = {};
        this.version = "";
        this.serviceName = "";
        this.dbHost = "";
        ...
        this.healthCheck = (path, headers, params, body) => __awaiter(this, void 0, void 0, function* () {
            return {
                path,
                headers,
                params,
            ...
            try {
                ...
                if (!!foundRoute) {
                    try {
                        ...
                        if (Buffer.isBuffer(input)) {
                            ...
                            requestPayload = yield (0, serverless_1.parseBufferPayload)(contentType, input);
                        }
                        else {
                            requestPayload = Object.assign({}, input);
                        }
                        const rp = yield handler(path, headers, params, requestPayload);
                        statusCode = 200;
                ...
                try {
                    ...
                    if (statusCode === 500) {
                        ...
                        yield (0, system_1.logError)(appId, this.serviceName, path, params, input, error === null || error === void 0 ? void 0 : error.message, error === null || error === void 0 ? void 0 : error.stack);
                    }
                }
                finally {
                    yield endSession();
